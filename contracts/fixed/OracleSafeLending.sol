...
contract OracleSafeLending is Ownable {
    IERC20 public collateralToken;
    IERC20 public loanToken;
    IERC20 public priceOracleToken;
    uint256 public fixedPrice;

    constructor(address _collateral, address _loanToken, uint256 _fixedPrice) Ownable(msg.sender) {
    ...
    function getPrice() public view returns (uint256) {
        // Fixed price logic
        return fixedPrice; // Return the fixed price instead of relying on oracle
    }
